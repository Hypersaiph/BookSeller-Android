...
import com.hypersaiph.bookseller.HttpClient.AsyncResponse;
import com.hypersaiph.bookseller.HttpClient.HttpPostAsyncTask;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] PERMISSIONS = {READ_CONTACTS, ACCESS_FINE_LOCATION, CAMERA, WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE};
    ...
    private boolean mayRequestContacts() {
        ...
        requestPermissions(new String[]{READ_CONTACTS, ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION, CAMERA, WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE}, REQUEST_READ_CONTACTS);
        return false;
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            postData.put("client_id", Globals.CLIENT_ID);
            postData.put("client_secret", Globals.CLIENT_SECRET);
            postData.put("username", email);
            postData.put("password", password);
            postData.put("scope", "");
            HttpPostAsyncTask task = new HttpPostAsyncTask(postData);
            task.delegate = this;
            task.execute(Globals.API_BASE_URL + "/oauth/token");
    ...
    public void processFinish(String response) {
        ...
        if (!response.equals("error")) {
            ...
            try {
                ...
                editor.putString("token_type", jsonObj.get("token_type").toString());
                editor.putInt("expires_in", Integer.parseInt(jsonObj.get("expires_in").toString()));
                editor.putString("access_token", jsonObj.get("access_token").toString());
                editor.putString("refresh_token", jsonObj.get("refresh_token").toString());
                editor.apply();
                Intent i = new Intent(LoginActivity.this, BottomNavigationMenu.class);
                startActivity(i);
                finish();
